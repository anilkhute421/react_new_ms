...
function EditSalary(props) {
  ...
  const fields = [
    { name: 'lastctc', inputlabel: 'Last CTC', gridwith: '6' },
    { name: 'inhandsalary', inputlabel: 'In Hand Salary', gridwith: '6' },
    { name: 'paymentmode', inputlabel: 'Mode of Payment', gridwith: '12' },
    { name: 'reviewdate', inputlabel: 'Last Salary Review Date', type: 'date', gridwith: '6' },
    { name: 'lastsalary', inputlabel: 'Hike on last salary', gridwith: '6' }
  ];
  return (
    <>
